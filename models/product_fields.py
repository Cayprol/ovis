...
class ProductCustomerInfo(models.Model):
	...
	name = fields.Many2one('res.partner', 'Customer', index=True, domain=[('res.partner.customer', '=?', True)], ondelete='restrict', required=True, help='Customer relates to this product')
